...
[![CI](https://github.com/sina-mohebbi/library-desk-sense/actions/workflows/ci.yml/badge.svg)](https://github.com/sina-mohebbi/library-desk-sense/actions/workflows/ci.yml)
[![License: MIT](https://img.shields.io/badge/License-MIT-green.svg)](LICENSE)

A smart library-desk monitor built around an ESP32 and a local Python backend. It senses whether a study desk is occupied, how bright the area is, and whether it's quiet enough for focused work.
...
The ESP32 reads distance, light, and sound sensors and streams them over HTTP/CoAP to a Python backend that stores the data in InfluxDB, shows live Grafana dashboards, runs analytics, and sends Telegram alerts.
